...
RGBApixel GetResizePixel(BMP &Old, int i, int M, int j, int N)
{
	RGBApixel Output;
	...
	if (I == Old.TellWidth() - 1)
	{
		...
		Output.Red = (char)((1.0 - ThetaT)*(Old(I, J)->Red + 0.0)
			+ ThetaT*(Old(I, J + 1)->Red + 0.0));
		Output.Green = (char)((1.0 - ThetaT)*(Old(I, J)->Green + 0.0)
			+ ThetaT*(Old(I, J + 1)->Green + 0.0));
		Output.Blue = (char)((1.0 - ThetaT)*(Old(I, J)->Blue + 0.0)
			+ ThetaT*(Old(I, J + 1)->Blue + 0.0));
		Output.Alpha = (char)((1.0 - ThetaT)*(Old(I, J)->Alpha + 0.0)
	...
	if (J == Old.TellHeight() - 1)
	{
		...
		Output.Red = (char)((1.0 - ThetaS)*(Old(I, J)->Red + 0.0)
			+ ThetaS*(Old(I + 1, J)->Red + 0.0));
		Output.Green = (char)((1.0 - ThetaS)*(Old(I, J)->Green + 0.0)
			+ ThetaS*(Old(I + 1, J)->Green + 0.0));
		Output.Blue = (char)((1.0 - ThetaS)*(Old(I, J)->Blue + 0.0)
			+ ThetaS*(Old(I + 1, J)->Blue + 0.0));
		Output.Alpha = (char)((1.0 - ThetaS)*(Old(I, J)->Alpha + 0.0)
	...
	Upper = (char)((1.0 - ThetaS)*(Old(I, J + 1)->Red + 0.0)
		+ ThetaS*(Old(I + 1, J + 1)->Red + 0.0));
	Lower = (char)((1.0 - ThetaS)*(Old(I, J)->Red + 0.0)
		+ ThetaS*(Old(I + 1, J)->Red + 0.0));

	Output.Red = (char)((1.0 - ThetaT)*(Lower + 0.0)
		+ ThetaT*(Upper + 0.0));

	// interpolate green

	Upper = (char)((1.0 - ThetaS)*(Old(I, J + 1)->Green + 0.0)
		+ ThetaS*(Old(I + 1, J + 1)->Green + 0.0));
	Lower = (char)((1.0 - ThetaS)*(Old(I, J)->Green + 0.0)
		+ ThetaS*(Old(I + 1, J)->Green + 0.0));
	Output.Green = (char)((1.0 - ThetaT)*(Lower + 0.0)
		+ ThetaT*(Upper + 0.0));

	// interpolate blue

	Upper = (char)((1.0 - ThetaS)*(Old(I, J + 1)->Blue + 0.0)
		+ ThetaS*(Old(I + 1, J + 1)->Blue + 0.0));
	Lower = (char)((1.0 - ThetaS)*(Old(I, J)->Blue + 0.0)
		+ ThetaS*(Old(I + 1, J)->Blue + 0.0));
	Output.Blue = (char)((1.0 - ThetaT)*(Lower + 0.0)
		+ ThetaT*(Upper + 0.0));

	// interpolate alpha

	Upper = (char)((1.0 - ThetaS)*(Old(I, J + 1)->Alpha + 0.0)
		+ ThetaS*(Old(I + 1, J + 1)->Alpha + 0.0));
	Lower = (char)((1.0 - ThetaS)*(Old(I, J)->Alpha + 0.0)
		+ ThetaS*(Old(I + 1, J)->Alpha + 0.0));
	Output.Alpha = (char)((1.0 - ThetaT)*(Lower + 0.0)
		+ ThetaT*(Upper + 0.0));
